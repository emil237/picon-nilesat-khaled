...
cd /tmp
set -e 
wget -q  "https://raw.githubusercontent.com/emilnabil/picon-nilesat-khaled/main/picon1.tar.gz"
wait
...
cd /tmp
set -e 
wget -q  "https://raw.githubusercontent.com/emilnabil/picon-nilesat-khaled/main/picon2.tar.gz"
wait
